...
4. Upload or capture a product image
5. Fill in details, click **Save Product**
6. Click **"Download All (JSON + Images)"** - downloads everything at once
7. Upload the folder to GitHub (see updating below)
